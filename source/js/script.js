...
$('.section5').slick({
  ...
  let btn_next1 =document.querySelector('.slick-prev').innerHTML=`<div class="arrow_section5 ">
  <img src="/source/image/left-arrow_right.png" alt="left_arrow" class="size-arrow_section5" >
</div>
`
let btn_next2 =document.querySelector('.slick-next').innerHTML=`<div class="arrow_section5 ">
  <img src="/source/image/left-arrow_right.png" alt="left_arrow" class="size-arrow_section5" >
</div>
`